                ...
                <ul class="navbar-nav">
                        ...
                        <div class="notification-dropdown dropdown-menu dropdown-menu-right"
                            ...
                            <div class="arrow_box_right">
                                <div class="noti-list" style="width: 500px; height:450px">
                                    ...
                                    @if ($item->click_action == 'SUBMITED_CHALLENGE_LIST_SCREEN' || $item->click_action
                                    == 'CHALLENGE_DETAIL_SCREEN' || $item->click_action ==
                                    'SUBMITED_CHALLENGE_DETAIL_SCREEN')
                                            ...
                                            <a class="dropdown-item noti-container py-2">
                                                ...
                                                <div class="row noti-wrapper">
                                                    <span class="noti-wrapper">
                                                        <i
                                                            class="ft-check-circle info float-left d-block font-medium-4 mt-2 mr-2"></i>
                                                        <span
                                                            class="noti-title line-height-1 d-block text-bold-400 info">{{$item->title}}</span>
                                                        <p class="noti-text">{{$item->body}}</p>
                                                    </span>
                                                </div>
                                                <span class="noti-text d-block text-bold-400 info"
                                                    style="float: right; right:0px">{{$item->created_at}}</span>
                                            </a>
                                            @endforeach
                                </div>
                            </div>
                            <a href="/notifications"
                                class="noti-footer primary text-center d-block border-top border-top-blue-grey border-top-lighten-1 text-bold-400 py-1">See
                                All</a>
                        </div>
                    </li>
                    <li class="dropdown nav-item mr-0">
                        ...
                        <div aria-labelledby="dropdownBasic3" class="dropdown-menu dropdown-menu-right">
                            <div class="arrow_box_right">
                                <a href="{{ route('profile') }}" class="dropdown-item py-1"><i
                                        class="icon-user mr-2"></i><span>{{$user->name ?? $user->username}}</span></a>
                                <a href="{{ route('changePassword') }}" class="dropdown-item py-1"><i
                                        class="ft-lock mr-2"></i><span>Change Password</span></a>
