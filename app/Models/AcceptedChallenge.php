...
class AcceptedChallenge extends Model
{
    ...
    {
        return $this->belongsTo(Challenge::class)->select(['id','title','description','start_time','file','result_type','user_id','duration_days', 'duration_hours', 'duration_minutes', 'allowVoter']);
    }
